...
namespace Context
{
    public class ApiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Author author1 = new("Cláudio Luís Vieira Oliveira");
            Author author2 = new("Humberto Augusto Piovesana Zanetti");
            Author author3 = new("Simon Monk");
            Author author4 = new("Luis Joyanes Aguilar");
