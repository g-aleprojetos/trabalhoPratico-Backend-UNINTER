...
namespace TrabalhoPratico_Backend.Context
{
    ...
    {
        public static readonly User userAdm = new("Administrador", "adm", "adm", "Usuario Adminitrativo", AccessType.ADM);
        public static readonly User userAluno = new("Alexandre", "Gonçalves", "3413992", "Tecnologia em Desenvolvimento de aplicativos Móveis",AccessType.USER);
        ...
        public List<Author> autores1 = new()
            {
                author1,
                author2
            };
